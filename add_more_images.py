...
def main():
    ...
    new_images = [
        r"C:/Users/user/.gemini/antigravity/brain/ff155c9d-6cdd-4020-a6ad-ebc44d680880/uploaded_image_0_1768875604404.jpg",
        r"C:/Users/user/.gemini/antigravity/brain/ff155c9d-6cdd-4020-a6ad-ebc44d680880/uploaded_image_1_1768875604404.jpg",
        r"C:/Users/user/.gemini/antigravity/brain/ff155c9d-6cdd-4020-a6ad-ebc44d680880/uploaded_image_2_1768875604404.jpg",
        r"C:/Users/user/.gemini/antigravity/brain/ff155c9d-6cdd-4020-a6ad-ebc44d680880/uploaded_image_3_1768875604404.jpg"
    ]
    
    # Inferred names based on visual content
    new_names = [
        "천창(Skylight) 워터웨이브 연출",
        "천창(Skylight) 워터웨이브 연출",
        "한옥 호텔 수공간(Water Feature)",
        "한옥 호텔 수공간(Water Feature)"
    ]
    ...
    final_count = start_num + len(added_files) - 1
